...
class RoadListViewModel extends ChangeNotifier {
  ...
  Future<String?> getRoadList(
    ...
    try {
      ...
      String endPoint = ApiEndPoints.getRoadList;
      String url = '${BaseUrlConfig.rootUrl}/$endPoint$stateCode"&districtCode="$districtCode"&blockCode="$blockCode"&villageCode="$villageCode"&habitationCode="$habitationCode"&lang=""CurrentLang"';
