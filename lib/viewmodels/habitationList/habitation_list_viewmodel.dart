...
class HabitationListViewModel extends ChangeNotifier {
  ...
  Future<String?> getHabitationList(
    String stateCode,
    String districtCode,
    String blockCode,
      String villageCode
    ...
    try {
      ...
      String endPoint = ApiEndPoints.getHabitationList;
      String url = '${BaseUrlConfig.rootUrl}/$endPoint$stateCode"&districtCode="$districtCode"&blockCode="$blockCode"&villageCode="$villageCode"&lang=""CurrentLang';
