...
class HomepageRoadCountsViewModel extends ChangeNotifier {
  ...
  Future<String?> getHomepageRoadCount(String stateCode, String districtCode, String blockCode) async {
    try {
      _setLoading(true);

      String endPoint = ApiEndPoints.getHomePageRoadCounts;
      String url = '${BaseUrlConfig.rootUrl}/$endPoint$stateCode"&districtCode="$districtCode"&blockCode="$blockCode';
