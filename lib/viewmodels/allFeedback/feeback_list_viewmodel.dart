...
class FeedbackListViewModel extends ChangeNotifier {
  ...
  Future<String?> getFeedbackList(String id, int pageNumber) async {
    try {
      _setLoading(true);

      String endPoint = ApiEndPoints.feedbackStatusByCitizenId;
      String url = '${BaseUrlConfig.rootUrl}/$endPoint$id"&counter="$pageNumber';
