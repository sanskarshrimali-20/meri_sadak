...
class GetReplyFileFeedbackViewModel extends ChangeNotifier {
  ...
  Future<String?> getReplyFileFeedback(String registrationNo, String mobileNo) async {
    try {
      _setLoading(true);
      var data = {
      ...
      String endPoint = ApiEndPoints.cpgramFeedbackStatus;
      String url = '${BaseUrlConfig.rootUrl}/$endPoint';

      // Make API call
      final response = await _apiService.postWithAuthToken(url, data);
