...
class RoadListCategoryWiseViewModel extends ChangeNotifier {
  ...
  Future<String?> getRoadListCategoryWise(
      String levelID,
      String stateID,
      String districtID,
      String blockID,
    ...
    try {
      ...
      String endPoint = ApiEndPoints.getRoadListCategoryWise;
      String url = '${BaseUrlConfig.rootUrl}/$endPoint$stateID"&districtCode="$districtID"&blockCode="$blockID';
