...
class GetReplyFileFeedbackViewModel extends ChangeNotifier {
  ...
  Future<String?> getReplyFileFeedback(String feedbackID) async {
    try {
      _setLoading(true);

      String endPoint = ApiEndPoints.getReplyFileOfFeedback;
      String url = '${BaseUrlConfig.rootUrl}/$endPoint$feedbackID';
